...
const placeholderImages = [
  "https://images.unsplash.com/photo-1625047509168-a7026f36de04?auto=format&fit=crop&q=80&w=1920",
  "https://images.unsplash.com/photo-1580273916550-e323be2ae537?auto=format&fit=crop&q=80&w=1920",
  "https://images.unsplash.com/photo-1578844251758-2f71da64c96f?auto=format&fit=crop&q=80&w=1920",
];
      ...
      <section className="relative pt-32 pb-20 px-6 min-h-[90vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto text-center w-full mt-20 md:mt-0">
          ...
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold tracking-tight mb-6 text-white drop-shadow-2xl leading-tight">
            Biztonság az <br className="hidden md:block" />
          ...
          <p className="text-lg md:text-2xl text-slate-300 max-w-3xl mx-auto mb-10 drop-shadow-md font-light leading-relaxed">
            Professzionális kerékcsere, klímatöltés és teljes körű autószerviz
            szolgáltatások Budapesten, modern gépparkkal, várakozás nélkül.
          </p>
